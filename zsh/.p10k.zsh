# Generated by Powerlevel10k configuration wizard on 2026-06-23 at 16:36 MSK.
...
# 2 lines, solid, full frame, lightest-ornaments, sparse, few icons, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=115
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=115
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local conflicted='%208F'  # red foreground
    else
